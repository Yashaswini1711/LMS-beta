            ...
            <CardBody>
                <form className='container p-6 bg-white rounded-lg' onSubmit={handleSubmitAllTopics}>
                            ...
                            <div key={index} className="flex flex-col gap-1">
                                <div className='form-group mt-1'>
                                    <Input
                                        ...
                                        onChange={(e) => handleChange(index, 'topicName', e.target.value)}
                                        variant='outlined'
                                        margin='normal'
                                    />
                                </div>
                                ...
                                <div className="flex justify-end">
                                    <Button variant="gradient" className="relative flex justify-center items-center w-1/5" onClick={() => handleDeleteTopic(index)}>
                                        <svg fill="#ffffff" height="18px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke="#ffffff">
                    ...
                    <div className="mb-4 flex flex-col md:flex-row justify-around gap-1">
                        <Button variant="gradient" onClick={handleAddTopic}>+</Button>
                        <Button type="submit" ripple={true} >Submit Topics and Finish</Button>
                    </div>
                </form>
            </CardBody>
        </Card>
